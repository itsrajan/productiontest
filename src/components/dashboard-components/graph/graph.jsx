...
let lineData = {
    ...
    datasets: [{
        ...
        pointBorderColor: 'rgb(94,114,228)',
        pointBackgroundColor: 'rgb(94,114,228)',
        data: [3, 5, 61, 1, 25, 1, 28, 92]
    }, {
        label: 'Sugarcane',
        borderWidth: 1,
        backgroundColor: 'rgba(139,23,39,.1)',
        borderColor: 'rgb(94,114,228)',
        pointBorderColor: 'rgb(94,114,228)',
        pointBackgroundColor: 'rgb(94,114,228)',
        data: [3.6, 7.3, 9.4, 3.1, 8.5, 8.1, 7.9, 7.9]
    }, {
        label: 'Wheat',
        borderWidth: 1,
        backgroundColor: 'rgba(64,166,3,.1)',
        borderColor: 'rgb(94,114,228)',
        pointBorderColor: 'rgb(94,114,228)',
        pointBackgroundColor: 'rgb(94,114,228)',
        data: [1.3, 1.5, 6.1, 6.1, 7.5, 7.1, 7.8, 7.1]
    }]
};
        ...
        <Card>
            <CardBody className="bg-darkGreen">
                <div className="d-flex align-items-center">
                    <div>
                        <CardTitle><div style={{fontSize: '130%'}}>PLANT STATUS</div></CardTitle>
                        <CardSubtitle>Information</CardSubtitle>
                    </div>
                    <div className="ml-auto d-flex align-items-center">
                        <ul className="list-inline font-12 dl mr-3 mb-0">
                            <h4><u><a href="#/alert">Advanced Analytics</a></u></h4>
                        </ul>
                    </div>
                </div>
                <Row>
