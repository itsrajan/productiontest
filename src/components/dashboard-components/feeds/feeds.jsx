...
const Feeds = () => {
    return (
        <Card>
            <CardBody>
                <CardTitle><div style={{fontSize: '150%'}}>UPDATES</div></CardTitle>
                <div className="feed-widget">
                    <ul className="list-style-none feed-body m-0 pb-3">
                        ...
                        <li className="feed-item">
                            <div className="feed-icon bg-danger"><i className="ti-user"></i></div>Email Address has been confirmed<span className="ml-auto font-12 text-muted">30 May</span>
                        </li>
                    </ul>
                </div>
            </CardBody>
